<live-event>
   <div class="insta-event">
    <h3 class="join-us">join us for our next <strong class="live-event">instagram live event</strong></h3>
   
    <h3 class="at-work"><q>being unapologetically you at work</q> <span class="live-event">wednesday, june 8 | 1pm PST</span></h3>
  </div>
