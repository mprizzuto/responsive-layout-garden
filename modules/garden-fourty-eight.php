<typographer>
	...
	<section class="typographer-rep">
		<blockquote class="type-advocacy" cite="https://en.wikipedia.org/wiki/Jan_Tschichold">
			<p><span class="leading-advocate">leading advocate of</span> <strong>modernist design in the late twenties</strong></p>
		</blockquote>
	</section>

	<aside class="typographer-info">
		<figure class="typographer">
			<picture class="typographer-portrait">
				<img src="https://i.ibb.co/nD9f6B5/tshci.png">
			</picture>
